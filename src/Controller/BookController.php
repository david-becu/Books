...
class BookController extends AbstractController {
    ...
    public function createBook( Request $request, SerializerInterface $serializer, EntityManagerInterface $managerBook, UrlGeneratorInterface $urlGenerator, AuthorRepository $authorRepository ): JsonResponse {
        ...
        // Récupération de l'auteur. S'il n'est pas défini, alors on met -1 par défaut.
    ...
    public function updateBook( Request $request, SerializerInterface $serializer, Book $currentBook, EntityManagerInterface $managerBook, UrlGeneratorInterface $urlGenerator, AuthorRepository $authorRepository ): JsonResponse {
        ...
        $managerBook->persist($updatedBook);
        $managerBook->flush();
